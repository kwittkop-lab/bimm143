...
``` r
count <- read.csv("GSE37704_featurecounts.csv", row.names = 1)
...
```
    ...
    Info: Working in directory /Users/kylewittkop/Desktop/UCSD Winter 2026/BIMM 143/bimm143/Class14
...
``` r
pathview(gene.data=foldchanges, pathway.id=keggresid, species="hsa")
```
...
![](hsa04114.pathview.png) ![](hsa04110.pathview.png)
![](hsa03440.pathview.png) ![](hsa03013.pathview.png)
![](hsa03030.pathview.png) Section 3. Gene Ontology (GO)
...
The pathway with the most significant entities P value was “Cycle,
mitotic”. No, the most significant pathways listed do not match our
previous KEGG results. Factors that could cause a difference between the
two methods could be the tools of enrichment of data such as
thresholding.
